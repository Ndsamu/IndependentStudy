...
define('DC_MASTER_KEY','3589e5d9493224023268d0ba33710a75');

// Admin URL. You need to set it for some features.
define('DC_ADMIN_URL','http://localhost/dotclear/mrrobot/admin/');

// Admin mail from address. For password recovery and such.
define('DC_ADMIN_MAILFROM','natedsamuelson@gmail.com');
