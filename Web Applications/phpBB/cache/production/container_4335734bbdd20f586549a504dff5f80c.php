...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000003a41d9a8000000006f1c4624(
...
class phpbbtemplatetwiglexer_000000003a41d9a8000000006f1c4624 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5bfedc70529a4471577672 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5bfedc70529a8381571077 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5bfedc7052993288820233 = array(
    ...
    {
        $this->initializer5bfedc70529a8381571077 && ($this->initializer5bfedc70529a8381571077->__invoke($valueHolder5bfedc70529a4471577672, $this, 'set_environment', array('env' => $env), $this->initializer5bfedc70529a8381571077) || 1) && $this->valueHolder5bfedc70529a4471577672 = $valueHolder5bfedc70529a4471577672;

        return $this->valueHolder5bfedc70529a4471577672->set_environment($env);
    }
    ...
    {
        $this->initializer5bfedc70529a8381571077 && ($this->initializer5bfedc70529a8381571077->__invoke($valueHolder5bfedc70529a4471577672, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5bfedc70529a8381571077) || 1) && $this->valueHolder5bfedc70529a4471577672 = $valueHolder5bfedc70529a4471577672;

        return $this->valueHolder5bfedc70529a4471577672->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5bfedc70529a8381571077 && ($this->initializer5bfedc70529a8381571077->__invoke($valueHolder5bfedc70529a4471577672, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5bfedc70529a8381571077) || 1) && $this->valueHolder5bfedc70529a4471577672 = $valueHolder5bfedc70529a4471577672;

        return $this->valueHolder5bfedc70529a4471577672->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5bfedc70529a8381571077 = $initializer;
    }
    ...
    {
        $this->initializer5bfedc70529a8381571077 && ($this->initializer5bfedc70529a8381571077->__invoke($valueHolder5bfedc70529a4471577672, $this, '__get', array('name' => $name), $this->initializer5bfedc70529a8381571077) || 1) && $this->valueHolder5bfedc70529a4471577672 = $valueHolder5bfedc70529a4471577672;

        if (isset(self::$publicProperties5bfedc7052993288820233[$name])) {
            return $this->valueHolder5bfedc70529a4471577672->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bfedc70529a4471577672;
    ...
    {
        $this->initializer5bfedc70529a8381571077 && ($this->initializer5bfedc70529a8381571077->__invoke($valueHolder5bfedc70529a4471577672, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5bfedc70529a8381571077) || 1) && $this->valueHolder5bfedc70529a4471577672 = $valueHolder5bfedc70529a4471577672;
    ...
    {
        $this->initializer5bfedc70529a8381571077 && ($this->initializer5bfedc70529a8381571077->__invoke($valueHolder5bfedc70529a4471577672, $this, '__isset', array('name' => $name), $this->initializer5bfedc70529a8381571077) || 1) && $this->valueHolder5bfedc70529a4471577672 = $valueHolder5bfedc70529a4471577672;
    ...
    {
        $this->initializer5bfedc70529a8381571077 && ($this->initializer5bfedc70529a8381571077->__invoke($valueHolder5bfedc70529a4471577672, $this, '__unset', array('name' => $name), $this->initializer5bfedc70529a8381571077) || 1) && $this->valueHolder5bfedc70529a4471577672 = $valueHolder5bfedc70529a4471577672;
    ...
    {
        $this->initializer5bfedc70529a8381571077 && ($this->initializer5bfedc70529a8381571077->__invoke($valueHolder5bfedc70529a4471577672, $this, '__clone', array(), $this->initializer5bfedc70529a8381571077) || 1) && $this->valueHolder5bfedc70529a4471577672 = $valueHolder5bfedc70529a4471577672;

        $this->valueHolder5bfedc70529a4471577672 = clone $this->valueHolder5bfedc70529a4471577672;
    }

    public function __sleep()
    {
        $this->initializer5bfedc70529a8381571077 && ($this->initializer5bfedc70529a8381571077->__invoke($valueHolder5bfedc70529a4471577672, $this, '__sleep', array(), $this->initializer5bfedc70529a8381571077) || 1) && $this->valueHolder5bfedc70529a4471577672 = $valueHolder5bfedc70529a4471577672;

        return array('valueHolder5bfedc70529a4471577672');
    }
    ...
    {
        return $this->initializer5bfedc70529a8381571077;
    }
    ...
    {
        return $this->initializer5bfedc70529a8381571077 && ($this->initializer5bfedc70529a8381571077->__invoke($valueHolder5bfedc70529a4471577672, $this, 'initializeProxy', array(), $this->initializer5bfedc70529a8381571077) || 1) && $this->valueHolder5bfedc70529a4471577672 = $valueHolder5bfedc70529a4471577672;
    }
    ...
    {
        return null !== $this->valueHolder5bfedc70529a4471577672;
    }
    ...
    {
        return $this->valueHolder5bfedc70529a4471577672;
    }
